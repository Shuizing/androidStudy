...
public class LoginActicity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.btn_forget:
                ...
                if (rb_password.isChecked()) {
                    // 以下携带手机号码跳转到找回密码页面
                    Intent intent = new Intent(this, ForgetPasswordActicity.class);
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (s.toString().length() == mMaxLength) {
                // 隐藏输入法软键盘
                ViewUtil.hideOneInputMethod(LoginActicity.this, mView);
            }
        }
    }
